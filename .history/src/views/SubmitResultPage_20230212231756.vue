    ...
    <div class="participants-list-container" v-if="participants.length">
      <ul class="participants-list">
        <li class="participants-list-item" v-for="participant in participants" :key="participant.id">
          ...
          <div class="radio">
            <input type="radio" :id=`lover${participant}` :name="participant.name" value="HTML" />
            <label for="lover" class="radio-label"></label>
          </div>
          <div class="radio">
            <input type="radio" id="friend" :name="participant.name" value="HTML" />
            <label for="friend" class="radio-label"></label>
          </div>
          <div class="radio">
            <input type="radio" id="not-interested" :name="participant.name" value="HTML" />
            <label for="not-interested" class="radio-label"></label>
          </div>
        </li>
      </ul>
    </div>
